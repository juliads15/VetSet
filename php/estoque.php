...
<html lang="pt-BR">
    <head>
        ...
        <title>Lista de estoque - VetSet</title>
    </head>
    <body>
        <header>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 text-right h2">
                    <a class="btn btn-primary" href="../src/cadastro-estoque.html"><i class="fa fa-plus"></i> Cadastrar Estoque </a>
                </div>
            </div>
                ...
                <div class="col-md-8">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <?php foreach($dados as $estoque) : ?>
                            <tr>
                                <td><?php echo $estoque['ID']; ?></td>
                                <td><?php echo $estoque['DESCRICAO']; ?></td>
                                <td><?php echo $estoque['TIPOPRODUTO']; ?></td>
                                <td><?php echo $estoque['QUANTIDADE']; ?></td>			
                                <td>
                                    <a href="../php/editar_consulta.php?ID=<?php echo $estoque['ID']; ?>" class="btn btn-info">Alterar</a>
                                    <a href="../php/excluir_consulta.php?ID=<?php echo $estoque['ID']; ?>" class="btn btn-danger">Excluir</a>
                                </td>
                            </tr>
