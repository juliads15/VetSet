...
<html lang="pt-BR">
    <head>
        ...
        <title>Lista de Veterinários - VetSet</title>
    </head>
    <body>
        <header>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 text-right h2">
                    <a class="btn btn-primary" href="../src/cadastro-veterinario.html"><i class="fa fa-plus"></i> Cadastrar Veterinário </a>
                </div>
            </div>
                ...
                <div class="col-md-8">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <?php foreach($dados as $veterinario) : ?>
                            <tr>
                                <td><?php echo $veterinario['ID']; ?></td>
                                <td><?php echo $veterinario['NOME']; ?></td>
                                <td><?php echo $veterinario['EMAIL']; ?></td>
                                <td><?php echo $veterinario['TELEFONE']; ?></td>
                                <td><?php echo $veterinario['ESPECIALIZACAO']; ?></td>
                                <td><?php echo $veterinario['CIDADE']; ?></td>				
                                <td>
                                    <a href="../php/editar_veterinario.php?ID=<?php echo $consulta['ID']; ?>" class="btn btn-info">Alterar</a>
                                    <a href="../php/excluir_veterinario.php?ID=<?php echo $consulta['ID']; ?>" class="btn btn-danger">Excluir</a>
                                </td>
                            </tr>
